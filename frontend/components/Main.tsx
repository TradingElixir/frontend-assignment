...
const styles = {
  ...
  confirmButton:
    "text-2xl shadow-solid-primary border-2 border-black py-1 px-1 transition-colors ease-out duration-500 text-white bg-gradient-to-r from-gray-900 to-black hover:from-white hover:to-gray-100 hover:text-black hover:border-black font-raleway-sans-serif grid place-content-center items-center w-100 h-12",
